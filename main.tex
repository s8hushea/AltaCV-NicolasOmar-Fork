...
\begin{document}
    ...
    \personalinfo{
        \email{a.sheaib988@gmail.com}\smallskip
        \phone{0096176840306}
        \location{Beirut, Lebanon}\\
        \linkedin{ahmad-sheaib-66091918a}
       % \github{johnDoe}
        %\dev{johnDoe}
    ...
    \begin{paracol}{2}
        % ----- STRENGTHS -----
        \cvsection{Strengths}
            \cvtag{Interpersonal Skills and Values}
            \cvtag{Teamwork}
            %\cvtag{Five}
            %\cvtag{Six}
            %\cvtag{Seven}
            ...
            \cvtag{Administrative Work}
            
            \cvtag{Day to Day Functions}
            %\cvtag{Blue}
            %\cvtag{Green}
            %\cvtag{Violet}
            %\cvtag{Orange}
        ...
        % ----- LEARNING -----
        \cvsection{Skills}
            \cvtag{Computer Tech \& Hardware}
            \cvtag{Computer Maintenance}
           % \cvtag{Cuatro}
            %\cvtag{Cinco}
            %\cvtag{Seis}
            %\cvtag{Siete}
        ...
        \cvsection{Experience}
            \cvevent{Internship }{| Decon International Company}{2018}{Beirut, Lebanon}
            \begin{itemize}
            ...
            \cvevent{Internship }{| eSchool-edu}{2019}{Beirut, Lebanon}
            \begin{itemize}
        ...
        % ----- EDUCATION -----
        \cvsection{Education}
            \cvevent{B.Sc. }{| Lebanese American University}{2016 -- 2020}{Beirut, Lebanon}
            \begin{itemize}
            ...
            \cvevent{Lebanese Baccalaureate }{| Rawdah High School}{2004 -- 2016}{Beirut, Lebanon}
            \begin{itemize}
        ...
        % ----- PROJECTS -----
        \cvsection{Projects}
            \cvevent{LAU-Answers }{\cvrepo{| \faGithub}{}\cvrepo{| \faGlobe}{}}{2019}{}
            \begin{itemize}
            ...
            \cvevent{GGWP }{\cvrepo{| \faGitlab}{}\cvrepo{| \faGlobe}{}}{2020}{}
            \begin{itemize}
